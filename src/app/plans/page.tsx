    ...
    >
      ...
      <button
        style={{
          ...
          boxShadow: '3px 3px 0px rgba(10,10,15,0.35)',
          borderRadius: 0,
          padding: '11px 0',
          width: '100%',
          cursor: 'pointer',
        ...
        onMouseUp={e => {
          const el = e.currentTarget as HTMLElement
          el.style.transform = ''
          el.style.boxShadow = '3px 3px 0px rgba(10,10,15,0.35)'
        }}
        onMouseLeave={e => {
          const el = e.currentTarget as HTMLElement
          el.style.transform = ''
...
export default function PlansPage() {
  ...
  function openInClaude() {
    window.open(`https://claude.ai/new?q=${encodeURIComponent(TEAM_PROMPT)}`, '_blank')
  }

  function openInChatGPT() {
    window.open(`https://chatgpt.com/?q=${encodeURIComponent(TEAM_PROMPT)}`, '_blank')
  }

  function openInGemini() {
    window.open(`https://gemini.google.com/app?q=${encodeURIComponent(TEAM_PROMPT)}`, '_blank')
  }
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  ...
                  <div
                    style={{
                      ...
                      padding: '10px 12px',
                      border: '1.5px solid #0A0A0F',
                      boxShadow: '2px 2px 0px rgba(10,10,15,0.2)',
                      maxWidth: '88%',
                      whiteSpace: 'pre-wrap',
                      lineHeight: 1.65,
                    }}
                  ...
                  {msg.showActions && (
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 2 }}>
                      <PixelBtn
                        onClick={copyTeamPrompt}
                        bg={copied ? '#2A5A2A' : '#0A0A0F'}
                        color={copied ? '#A8D8A8' : '#E8E0D0'}
                        border="1.5px solid #0A0A0F"
                        shadow="2px 2px 0px rgba(10,10,15,0.5)"
                      >
